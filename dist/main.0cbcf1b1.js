...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"C:\\Users\\xiao\\AppData\\Local\\Yarn\\Data\\global\\node_modules\\parcel\\src\\builtins\\css-loader.js"}],"C:\\Users\\xiao\\AppData\\Local\\Yarn\\Data\\global\\node_modules\\process\\browser.js":[function(require,module,exports) {
...
//运算结果记忆功能
var n = localStorage.getItem('temp'); // n变量，读取本地内存中的n，存的是运算好的值
$number.text(n || 100); //数字区域显示的是运算后的数值，刷新也不变，应为这个值是从本地调用的
$button1.on('click', function () {
    var n = parseInt($number.text()); //获取文本字符串然后变成数字
    n += 1; //运算
...
var $tabContent = (0, _jquery2.default)('#app2 .tab-content'); //获取tab-content列表 便于后续操作
$tabBar.on('click', 'li', function (e) {

    var $li = (0, _jquery2.default)(e.currentTarget); //currentTarget 实际点到的
    $li.addClass('selected').siblings().removeClass('selected'); //点击的模块实现选中效果
    var index = $li.index(); //第几个li 序号
...
require('./app4.js');
},{"./reset.css":"reset.css","./global.css":"global.css","./app1.js":"app1.js","./app2.js":"app2.js","./app3.js":"app3.js","./app4.js":"app4.js"}],"C:\\Users\\xiao\\AppData\\Local\\Yarn\\Data\\global\\node_modules\\parcel\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.0cbcf1b1.map